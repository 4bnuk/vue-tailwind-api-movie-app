          ...
          <ul class="flex items-center mt-4">
            <li v-if="personSocial.facebook_id">
              <a :href="`https://facebook.com/${personSocial.facebook_id}`" title="Facebook">
                <svg class="fill-current dark:text-gray-400 dark:hover:text-white text-gray-500 hover:text-white w-6" viewBox="0 0 448 512">
                  <path
            ...
            <li v-if="personSocial.twitter_id" class="ml-6">
              <a :href="`https://twitter.com/${personSocial.twitter_id}`" title="Twitter">
                <svg class="fill-current dark:text-gray-400 dark:hover:text-white text-gray-500  hover:text-white w-6" viewBox="0 0 512 512">
                  <path
            ...
            <li v-if="person.homepage" class="ml-6">
              <a :href="person.homepage" title="Website">
                <svg class="fill-current dark:text-gray-400 dark:hover:text-white text-gray-500 hover:text-white w-6" viewBox="0 0 496 512">
                  <path
