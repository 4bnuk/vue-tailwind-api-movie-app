  ...
  <div v-if="renderTemplate">
    <div class="movie-info border-b border-gray-800">
      <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        ...
        <div class="md:ml-24">
          <h2 class="text-4xl mt-4 md:mt-0 font-semibold text-amber-300">{{ movie.title }}</h2>
          <div class="flex flex-wrap items-center text-gray-400 text-sm">
            <svg class="fill-current text-amber-300 w-4" viewBox="0 0 24 24">
              <g data-name="Layer 2">
                <path
          ...
          <div class="mt-12">
            <h4 class="text-amber-300 font-semibold">Featured Crew</h4>
            <div class="flex mt-4">
    ...
    <div class="movie-cast border-b border-gray-800">
      <div class="container mx-auto px-4 py-16">
        <h2 class="text-amber-300 text-4xl font-semibold">Cast</h2>
    ...
    <div class="movie-images">
      <div class="container mx-auto px-4 py-16">
        <h2 class="text-amber-300 text-4xl font-semibold">Images</h2>
