    ...
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
      <ul class="flex flex-col md:flex-row items-center">
        ...
        <li class="md:ml-16 mt-3 md:mt-0">
          <router-link class="hover:text-gray-300" to="/">Movies</router-link>
        </li>
        <li class="md:ml-16 mt-3 md:mt-0">
          <router-link class="hover:text-gray-300" to="/about">About</router-link>
        </li>
        <li class="md:ml-16 mt-3 md:mt-0">
          <router-link class="hover:text-gray-300" to="/people">People</router-link>
        </li>
      </ul>
