  ...
  <nav class="border-b dark:border-gray-800 border-gray-400">
    <div class="container mx-auto py-3.5 px-5 md:flex">
      ...
      <ul class="dark:bg-gray-900 bg-slate-200 text-xl md:flex md:items-center md:px-0 px-10 md:pb-0 pb-10 md:static absolute 
        ...
        <li class="md:mx-4 md:my-0 my-6">
          <router-link @click="toggleMenu" class="dark:hover:text-gray-300 hover:text-gray-500" to="/tvShows">Tv Shows
          </router-link>
        </li>
        <li class="md:mx-4 md:my-0 my-6">
          <router-link @click="toggleMenu" class="dark:hover:text-gray-300 hover:text-gray-500" to="/people">People
          </router-link>
        </li>
      </ul>
      <div class="ml-auto md:flex md:items-center md:px-0 px-10 md:pb-0 pb-10 md:static absolute
        ...
        <div class="flex flex-col md:flex-row">
          <div class="relative mt-3 md:mt-0" ref="target">
            ...
            <svg v-show="toggleSpinner" role="status" class="absolute top-1 right-2 w-5 h-5 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
            ...
            <div v-show="searchText.length > 2 && searchIsOpen"
              ...
              <div v-show="noResults" class="px-3 py-3">No results for "{{ searchText }}"</div>
            </div>
          </div>
        </div>
      </div>
